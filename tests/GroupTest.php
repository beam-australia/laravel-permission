...
class GroupTest extends TestCase
{
    ...
    /** @test */
    public function it_creates_a_group_with_findOrCreate_if_the_named_group_does_not_exist()
    {
        $this->expectException(GroupDoesNotExist::class);

        $group1 = app(Group::class)->findByName('non-existing-group');

        $this->assertNull($group1);

        $group2 = app(Group::class)->findOrCreate('yet-another-group');
